...
const submitProduct = async (req, res) => {
	try {
		const { product_name, affiliate_link } = req.body; // Update variable names
		...
		console.log('productName length:', product_name.length);
		console.log('affiliateLink length:', affiliate_link.length);

		const newProduct = await Product.create({
			product_name, // Update variable name
			affiliate_link, // Update variable name
